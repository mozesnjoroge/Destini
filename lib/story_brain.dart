...
class StoryBrain {
  ...
  List<Story> _storyData = [
    ...
    Story(
        storyTitle:
            ...
            'Inside you find a bloody knife, two severed fingers, and a cassette tape of Elton John. He reaches for the glove box.',
    ...
    Story(
        storyTitle:
            'As you smash through the guardrail and careen towards the jagged rocks below '
            'you reflect on the dubious wisdom of stabbing someone while they are driving a car you are in.',
        choice1: 'Restart',
        choice2: ''),
    Story(
        storyTitle:
  ...
  String getFirstChoice() => _storyData[_storyNumber].choice1;
  String getSecondChoice() => _storyData[_storyNumber].choice2;
